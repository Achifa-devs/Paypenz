let verification_email = (token,email,name) => {
    ...
    <body>
        <div class="container">
            <h1>Paypenz Nigeria. </h1>
            <p>Hello ${name},</p>
            <p>Thank you for choosing Paypenz Nigeria! To complete your Email Verification, please click the link below:</p>
            <button>www.paypenz.com/email-verification/${token}?email=${email}</button>
            ...
            <p>Thank you for using Paypenz Nigeria.</p>
            <p>Best regards,</p>
            <p>${name}<br>
